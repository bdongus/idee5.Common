...
namespace idee5.Common.Data {
    ...
    /// </summary>
    /// <remarks>The difference to <see cref="IRepository{T, TKey}"/> is the missing primary key type.
    /// </remarks>
    /// <typeparam name="T">The <see cref="Type">type</see> of item in the repository.</typeparam>
    public interface ICompositeKeyRepository<T> : IQueryRepository<T> where T : class {
        /// <summary>
        ...
        /// <summary>
        /// Executes an <see cref="Action"/> on all items meeting the specified conditions.
        /// </summary>
